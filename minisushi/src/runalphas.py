...
def inibeta(nf, nloopin):
	...
	beta1 = (102.0 - (38*nf)/3.0)/16.0
	beta2 = (2857.0/2.0 - (5033.0*nf)/18.0 + (325.0*nf**2)/54.0)/64.0
	beta3 = (149753.0/6.0 + (1093.0*nf**3)/729.0 + 3564.0*z3 + nf**2*(50065.0/162.0 + (6472.0*z3)/81.0)
		- nf*(1078361.0/162.0 + (6508.0*z3)/27.0))/256.0
	nloop = nloopin
